...
```{r H1 simulation, include=FALSE, warning=FALSE, eval=FALSE}
...
```{r H0 simulation, include=FALSE, warning=FALSE, eval=FALSE}
totalCores = detectCores()
...
```{r experiment new params simulation, include=FALSE, warning=FALSE, eval=FALSE}
k.values = seq(3, 7)
...
```{r prepare values for plotting, include=FALSE, eval=FALSE}
...
fmri.p = friedman.test.permute.par(ts.feat, alpha = 0.05, p = 1e2, model = "svm")
