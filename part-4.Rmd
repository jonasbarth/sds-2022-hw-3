...
```{r simulation loop, include=FALSE}
...
We run the Friedman test on the engineered fMRI data with $p = 100$ permutations. We are using the Support Vector Machine (SVM) classifier to help combat overfitting.
