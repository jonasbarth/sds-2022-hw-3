...
results.H1 = foreach(i = 1:M, .combine=c, .packages = "random.data") %dopar% {
  generated = create.data(n0, n1, k, H0 = FALSE)
...
results.H0 = foreach(i = 1:M, .combine=c, .packages = "random.data") %dopar% {
  generated = create.data(n0, n1, k, H0 = TRUE)
...
for (i in 1:nrow(params.df)) {
  ...
  size = foreach(i = 1:M, .combine=c, .packages = "random.data") %dopar% {
    generated = create.data(n0, n1, row$k, H0 = TRUE)
    
    p.value = friedman.test.permute(generated$df, alpha = alpha, p = n0 + n1)
    p.value
  }
  power = foreach(i = 1:M, .combine=c, .packages = "random.data") %dopar% {
    generated = create.data(n0, n1, row$k, H0 = FALSE)
